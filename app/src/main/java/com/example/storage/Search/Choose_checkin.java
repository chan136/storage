...
public class Choose_checkin extends AppCompatActivity {
    ...
    private int sort_id;
    private ChooseCheckinAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_checkin);
        ...
        init();
        adapter = new ChooseCheckinAdapter(this,R.layout.choose_checkin_item,checkinList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent verify = new Intent(Choose_checkin.this, Verify_checkin.class);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        View view = LayoutInflater.from(this).inflate(R.layout.activity_select_checkin,null);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.sort:
                ...
                ensure1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SortListview.checkinSort(adapter,checkinList,flag,sort_id);
                        sort_id = 0;
                        dialog1.dismiss();
                    }
                });
