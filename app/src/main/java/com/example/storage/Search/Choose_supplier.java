...
public class Choose_supplier extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        adapter = new ChooseSupplierAdapter(this,R.layout.choose_supplier_item,supplierList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent verify = new Intent(Choose_supplier.this, Verify_supplier.class);
