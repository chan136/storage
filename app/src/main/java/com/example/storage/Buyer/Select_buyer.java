...
public class Select_buyer extends AppCompatActivity {
    ...
    private NewBuyerAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        adapter = new NewBuyerAdapter(this,R.layout.select_device_item,buyerList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent verify = new Intent(Select_buyer.this, Verify_buyer.class);
