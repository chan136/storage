...
public class Checkout_photo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        View view = LayoutInflater.from(this).inflate(R.layout.activity_checkout_photo,null);
        DrawableColor.changeColor(view,R.id.addphoto,R.drawable.ic_add_a_photo_black,R.color.gray);
        setContentView(R.layout.activity_checkout_photo);
