...
public class Update_device extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.activity_update_device,null);
        ...
        toolbar.setBackgroundColor(getResources().getColor(R.color.light_pink));
        StatusBarUtils.setStatusBar(this,getResources().getColor(R.color.select_device));
        toolbar.setTitleTextColor(getResources().getColor(R.color.select_device));
        setSupportActionBar(toolbar);

        final Drawable upArrow = getResources().getDrawable(R.drawable.ic_arrow_back_black_24dp);
        upArrow.setColorFilter(getResources().getColor(R.color.select_device), PorterDuff.Mode.SRC_ATOP);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.type:
                ...
                View view = LayoutInflater.from(this).inflate(R.layout.type_select,null);
            ...
            case R.id.color:
                ...
                final View view2 = LayoutInflater.from(this).inflate(R.layout.color_select,null);
            ...
            case R.id.device_ensure:
                ...
                finish();
                startActivity(new Intent(this,Select_device.class));
                break;
            default:break;
        }
    }
    ...
    private void ensure() {
        if (device_SKU.getText().toString().trim().equals("") || device_name.getText().toString().trim().equals("")) {
            ...
            device.setSKU(device_SKU.getText().toString());
            ...
            device.updateAll("SKU = ?",device.getSKU());
