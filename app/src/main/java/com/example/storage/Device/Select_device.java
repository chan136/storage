...
public class Select_device extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.select_device_item,null);
        ...
        init();
        adapter = new NewDeviceAdapter(this,R.layout.select_device_item,deviceList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent verify = new Intent(Select_device.this, Verify_device.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.skip:
                ...
                View view = LayoutInflater.from(this).inflate(R.layout.device_skip, null);
            ...
            case R.id.sort:
                ...
                View view1 = LayoutInflater.from(this).inflate(R.layout.device_sort, null);
                ...
                DrawableColor.changeColor(view1,R.id.btn5,R.drawable.ic_arrow_down_24dp,R.color.select_device);
                DrawableColor.changeColor(view1,R.id.btn5,R.drawable.ic_arrow_up_24dp,R.color.select_device);
                DrawableColor.changeColor(view1,R.id.btn6,R.drawable.ic_arrow_down_24dp,R.color.select_device);
                DrawableColor.changeColor(view1,R.id.btn6,R.drawable.ic_arrow_up_24dp,R.color.select_device);
                ...
                view1.findViewById(R.id.three).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ControlUpDown.control(btn3,R.drawable.ic_arrow_up_24dp,R.drawable.ic_arrow_down_24dp,btn1,btn2,btn4,btn5,btn6);
                        sort_id =3;
                    }
                });
