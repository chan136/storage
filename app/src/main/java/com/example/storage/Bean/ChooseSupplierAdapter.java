 ...
 */
public class ChooseSupplierAdapter extends ArrayAdapter<NewSupplier> {
    ...
    public ChooseSupplierAdapter(Context context, int textViewResourceId, List<NewSupplier> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        NewSupplier supplier = getItem(position);
        ...
        first_name.setText(supplier.getName().substring(0,1));
